...
<br> let numbCentury;
<br>function century(year) {
  <br>let year1 = String(year);
  <br>let yearsubs = year1.substr(-2, 2)
  <br>if (yearsubs == "00"){
  <br>let century1 = +year1.slice(0,-2);
  <br>return century1;
  <br>} else {
    <br>let century1 = +year1.slice(0,-2) + 1;
    <br>return century1;
  <br>}
<br>}
<br>console.log(century(11101))
## Expirience
## Education 
